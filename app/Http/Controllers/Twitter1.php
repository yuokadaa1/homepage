...
class Twitter extends Controller
{
  ...
  public function search(Request $request)
  {
    ...
    // conversation元のツイートを取得
    $originTweet = $this->curlCoal("ids",$request,$nextToken);
    $originTweet->data[0]->username = $originTweet->includes->users[0]->username;
    $arrayDataS = array_merge($arrayDataS,$originTweet->data );
