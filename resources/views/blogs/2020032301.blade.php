...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">初心者の投資について</li>
  </ol>
</nav>
...
<div class="container mb-4" >
  <div class="card card-body" >
    ...
    <a href="#1st" class="router-link-exact-active router-link-active" style="text-indent:1em;">投資の善悪について</a>
...
<div class="container mb-4" id="ZERO">
  ...
  <div  style="padding-left: 1em;">
    ...
    <p>
      当サイトに記載されていることは偏見と無知に満ちています。情報元が明示されているもの以外は「と思います」という後ろ書きが付いているものと思って読んでください。
    </p>
    <p>
      じゃあ他のサイトでも見るか・・・といったところで他のサイトもポジショントークで満ちています。情報量や正確さに違いはあっても個人にとっての正解が記載されていることはあり得ませんし、正しい投資法というのも存在しません。全員が<u><a style="color:red;">各々の利益を最大化すべき動いています<a></u>。情報収集はその前提で考えて自己判断が必要になります。
    </p>
  </div>
</div>
