...
@section('title', 'エリオット波動とフィボナッチ比率')
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">エリオット波動とフィボナッチ比率</li>
  </ol>
</nav>

<div class="container mb-4">
  <h3>エリオット波動とフィボナッチ比率</h3>
</div>

<div class="container mb-4" >
  <div class="w-50 card card-body" >
    <a>目次<a>
    <a href="#ZERO" class="router-link-exact-active router-link-active" style="text-indent:1em;">エリオット波動とフィボナッチ比率</a>
...
<div class="container mb-4" id="ZERO">
  <h5>エリオット波動とフィボナッチ比率</h5>
  <div  style="padding-left: 1em;">

    <p class="my-2">エリオット波動で局面を把握し、フィボナッチ比率で上限・加減を計る</p>
